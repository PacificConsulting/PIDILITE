pageextension 50108 "BankPmtVoucher_Ext" extends "Bank Payment Voucher"
{
    layout
    {
        modify("Debit Amount")
        ...
        moveafter("GST Reason Type"; "Bank Charge", "Vendor GST Reg. No.")
        ...
        moveafter("GST Transaction Type"; "Location GST Reg. No.")
